  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-brand-bg/30">
          {!user && !checkingAuth ? (
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              ...
              <h4 className="font-bold text-brand-text mb-2 text-base">Fitur Khusus Member</h4>
              <p className="text-sm text-brand-muted mb-6">
                Silakan masuk atau daftar akun KodeRuang untuk berdiskusi dengan asisten AI kami.
              </p>
              <Link 
                href="/register" 
                className="w-full bg-brand-primary text-brand-surface py-2.5 rounded-md font-bold hover:bg-brand-primary/90 transition-all text-center"
              >
                Daftar Sekarang
              </Link>
              <Link 
        ...
        {/* Input - Only show for logged in users */}
        {user && (
